...
| P27 | Aluguel só era separado pelo piso de R$50k no treino (heurística de preço). Medido no Rocha: 4 de 467 aluguéis passavam, 7 de 696 vendas eram descartadas. Filtro explícito por `Tipo_Negocio` foi adicionado ao `prepare_dataset.py` em 2026-08-11, mas **o modelo publicado ainda é o antigo** — só vale a partir do próximo retreino | Contaminação residual | `prepare_dataset.py` |
